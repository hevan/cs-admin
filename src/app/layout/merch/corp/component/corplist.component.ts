...
export class CorpListComponent implements OnInit {
    ...
    //构造
    constructor(private toastrService:ToastrService,private fb: FormBuilder,private location: Location, private route: ActivatedRoute,private router: Router,private corpService: CorpService,private authService:AuthService) {
    ...
    paginateQuery(event) {
        ...
        this.corpService.pageQuery(paramsContract).subscribe(res=>{
            ...
            this.toastrService.error("业务接口网络异常");
        });
    }
