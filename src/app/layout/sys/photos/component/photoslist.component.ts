...
import {PhotosService} from "../../../../shared/services/common/photos.service";

@Component({
    selector: 'app-sys-photoslist',
...
export class PhotosListComponent implements OnInit {
    ...
    //构造
    constructor(private fb: FormBuilder,private location: Location, private route: ActivatedRoute,private router: Router,private photosService: PhotosService,private authService:AuthService) {
    ...
    paginateQuery(event) {
        ...
        this.photosService.pageQuery(paramsContract).subscribe(res=>{
            if(res.code == 0){
